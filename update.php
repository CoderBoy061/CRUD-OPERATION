...
<html lang="en">
  <head>
    ...
    <title>User Update Register</title>
    <style>
      #stateId{
        width:40vw;
        padding:8px;
...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `user` SET `id`=$id,`user_name`=$name,`user_email`=$email,`user_mobile`=$phone,`user_state`=$state,`user_city`=$city,`user_address`=$address WHERE id=$id";
...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="contact">
    <h3 class="text-center"><u>Update Your account</u></h3>
